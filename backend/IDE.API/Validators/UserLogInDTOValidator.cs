    ...
    public class UserLogInDTOValidator: AbstractValidator<UserLoginDTO>
    {
        public UserLogInDTOValidator()
        {
            RuleFor(u => u.Email)
                ...
                .Matches("[^.]{0}[a-zA-Z0-9._]{1,35}[^.]{0}@[^-]{0}[a-zA-Z0-9.]{3,35}[^-]{0}").WithMessage("Email can only contain latin letters(upper\\lowercase), digits, \".\", \"_\", \"@\". \".\" can not be first or last symbol.");
